...
export async function GET(req: Request) {
  ...
  const url = `https://ghost-main-static-b7ec98c880a54ad5a4782393902a32a2.ghostapi.app:29003/api/ghost/v2/autocomplete?companyID=1&text=${encodeURIComponent(text)}`;
